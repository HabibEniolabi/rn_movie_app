...
const ProfileCardNavigation = ({
  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.8}>
      <View className="flex-row gap-4 items-center justify-between border border-dark-400 rounded-[24px] bg-dark-300 px-4 py-4">
        <View className="flex-row gap-3 items-center">
          <View
            className={`justify-center items-center rounded-[14px] p-4`}
